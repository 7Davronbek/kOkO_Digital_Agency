        ...
        <>
            <div className="socialFixed">
                <a target='_blank' rel="noreferrer"
                    ...
                    className=' cursor'><i className={`icon icon-instagram ${localStorage.getItem('theme') === 'white' ? 'black' : ''}`}></i></a>
                ...
                <a target='_blank' rel="noreferrer"
                    ...
                    className='cursor'><i className={`icon icon-facebook ${localStorage.getItem('theme') === 'white' ? 'black' : ''}`}></i></a>
